...
public class ElevatorConstants {
    public static final PIDF gains = switch (Constants.identity) {
        case COMPBOT -> null;
        case SIMBOT, ALPHABOT -> PIDF.ofPDSVAG(0.0, 0.0, 0, 0.08, 0.05, 5.8593);
    };
    ...
    private static final double sprocketRadiusMeters = Units.inchesToMeters(1.5);
...
//    public static final double maxVelocitySlowdownZoneMetersPerSecond = maxVelocityMetersPerSecond / 4;
