...
public class DriveConstants {
    ...
    public static final frc.robot.subsystems.drive.ModuleIO[] moduleIO = Constants.isReplay
            ? new frc.robot.subsystems.drive.ModuleIO[]{new frc.robot.subsystems.drive.ModuleIO(), new frc.robot.subsystems.drive.ModuleIO(), new frc.robot.subsystems.drive.ModuleIO(), new frc.robot.subsystems.drive.ModuleIO()}
        ...
        case COMPBOT -> new frc.robot.subsystems.drive.ModuleIO[]{
                // FL, FR, BL, BR
        ...
        case ALPHABOT -> new frc.robot.subsystems.drive.ModuleIO[]{
                // FL, FR, BL, BR
