...
public class ClimberIOTalonFX extends ClimberIO {
    ...
    public ClimberIOTalonFX(int canID, boolean inverted, int encoderChannel, double absoluteEncoderOffsetRad) {
    ...
    public void updateInputs(ClimberIOInputs inputs) {
        ...
        inputs.absolutePositionRad = absoluteEncoder.get() - absoluteEncoderOffsetRad;
    }
