...
public class Superstructure extends CommandBasedSubsystem {
    ...
    public enum Goal {
        IDLE(s -> new Goals(Elevator.Goal.STOW, EndEffector.Goal.IDLE, Funnel.Goal.IDLE, Indexer.Goal.IDLE)),

        MANUAL_SCORE_CORAL_WAIT_FOR_ELEVATOR(s -> new Goals(s.ctx.level().coralScoringElevatorGoal, EndEffector.Goal.IDLE, Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        ...
        DESCORE_ALGAE_WAIT_FOR_ELEVATOR(s -> new Goals(s.ctx.reefSide().algaeDescoringElevatorGoal, EndEffector.Goal.IDLE,
                Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        DESCORE_ALGAE_DESCORING(s -> new Goals(s.ctx.reefSide().algaeDescoringElevatorGoal, EndEffector.Goal.DESCORE_ALGAE,
                Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        ...
        HANDOFF(s -> new Goals(Elevator.Goal.STOW, EndEffector.Goal.FUNNEL_INTAKE, Funnel.Goal.INTAKE_ALTERNATE, Indexer.Goal.INTAKE_ALTERNATE)),
        HOME_STEP_1(s -> new Goals(Elevator.Goal.ZERO_CORAL, EndEffector.Goal.HOME_INITIAL, Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        HOME_STEP_2(s -> new Goals(Elevator.Goal.ZERO_CORAL, EndEffector.Goal.ZERO_CORAL, Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        HOME_STEP_3(s -> new Goals(Elevator.Goal.STOW, EndEffector.Goal.IDLE, Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        HOME_STEP_4(s -> new Goals(Elevator.Goal.STOW, EndEffector.Goal.HOME_FINAL, Funnel.Goal.IDLE, Indexer.Goal.IDLE)),
        ...
        EJECT(s -> new Goals(Elevator.Goal.STOW, EndEffector.Goal.EJECT_ALTERNATE, Funnel.Goal.EJECT_ALTERNATE, Indexer.Goal.EJECT_ALTERNATE)),
