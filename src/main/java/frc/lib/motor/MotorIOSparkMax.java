...
public class MotorIOSparkMax extends MotorIO {
    ...
    public MotorIOSparkMax(
        ...
        positionGains.applySparkWithoutFeedforward(config.closedLoop, ClosedLoopSlot.kSlot0);
        velocityGains.applySparkWithoutFeedforward(config.closedLoop, ClosedLoopSlot.kSlot1);
        config
                .signals
